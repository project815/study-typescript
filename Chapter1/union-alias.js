...
function typeAlias(input1, input2, type) {
    let result;
...
const user = { name: 'song', age: 14, height: 145 };
const maker = { name: 'akakak', age: 19, height: 190 };
let user4 = { name: 'song', age: 123, height: 123 };
console.log(user4);
user4 = '"Maiesr';
console.log(user4);
user4 = 4;
